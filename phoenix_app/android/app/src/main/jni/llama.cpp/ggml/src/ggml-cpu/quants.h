...
void quantize_row_i8_s  (const float * GGML_RESTRICT x, void * GGML_RESTRICT y, int64_t k, float * act_scales, int32_t * act_sums);
void quantize_row_i8_s_4x1(const float * GGML_RESTRICT x, void * GGML_RESTRICT y, int64_t k, float * act_scales, int32_t * act_sums);
