...
extern "C" {
    ...
    enum ggml_type {
        ...
        GGML_TYPE_TQ1_0   = 34,
        GGML_TYPE_TQ2_0   = 35,
        GGML_TYPE_I2_S    = 36, // BitNet b1.58 ternary (2 bits per weight)
        GGML_TYPE_I8_S    = 37, // BitNet activation quantization (int8 + scale)
    ...
    enum ggml_ftype {
        ...
        GGML_FTYPE_MOSTLY_I2_S    = 27, // BitNet b1.58 ternary
    };
